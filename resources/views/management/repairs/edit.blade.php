...
<div class="content-wrapper">
        ...
        <div class="col-md-12 grid-margin">
            <div class="row">
                <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                    <h3 class="font-weight-bold">Edit Perbaikan</h3>
                    <h6 class="font-weight-normal mb-0">Perbarui informasi perbaikan asset</h6>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-lg-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Form Edit Perbaikan</h4>
                    ...
                    <form action="{{ route('repairs.update', $repair) }}" method="POST" class="forms-sample">
                        @csrf
                        @method('PUT')
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="damage_report_id" name="damage_report_id" required>
                                        ...
                                        <option value="{{ $report->id }}"
                                                ...
                                                {{ old('damage_report_id', $repair->damage_report_id) == $report->id ? 'selected' : '' }}>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="datetime-local" class="form-control" id="repair_start_date" name="repair_start_date"
                                           value="{{ old('repair_start_date', $repair->repair_start_date->format('Y-m-d\TH:i')) }}" required>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="datetime-local" class="form-control" id="repair_end_date" name="repair_end_date"
                                           value="{{ old('repair_end_date', $repair->repair_end_date ? $repair->repair_end_date->format('Y-m-d\TH:i') : '') }}">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="repaired_by" name="repaired_by"
                                           value="{{ old('repaired_by', $repair->repaired_by) }}" required>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="repair_cost" name="repair_cost"
                                           value="{{ old('repair_cost', $repair->repair_cost) }}" min="0" step="1000" required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="repair_description" name="repair_description" rows="4" required>{{ old('repair_description', $repair->repair_description) }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="spare_parts_used" name="spare_parts_used" rows="3">{{ old('spare_parts_used', $repair->spare_parts_used) }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="status" name="status" required>
                                ...
                                <option value="failed" {{ old('status', $repair->status) == 'failed' ? 'selected' : '' }}>Failed</option>
                            </select>
                        </div>

                        <div class="form-group">
                            <label for="notes">Catatan</label>
                            <textarea class="form-control" id="notes" name="notes" rows="3">{{ old('notes', $repair->notes) }}</textarea>
                        </div>
