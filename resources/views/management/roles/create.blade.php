    ...
    <div class="col-lg-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                ...
                <p class="card-description">Isi form di bawah untuk menambahkan role baru</p>
                ...
                <form action="{{ route('roles.store') }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <div class="border rounded" style="max-height: 450px; overflow-y: auto; padding: 0.5rem 0;">
                            ...
                            <div class="permission-item {{ in_array($permission->id, old('permissions', [])) ? 'checked' : '' }}" data-permission-id="{{ $permission->id }}"
                        ...
                        <small class="text-muted d-block mt-2">
                            <span id="selectedPermissionsCount">{{ count(old('permissions', [])) }}</span> permission dipilih
                        </small>
                    </div>
