...
class MaintenanceScheduleRepository
{
    ...
    {
        return MaintenanceSchedule::with(['asset.category', 'asset.room.building'])
            ->latest()
            ->paginate($perPage);
    }
    ...
    {
        $query = MaintenanceSchedule::with(['asset.category', 'asset.room.building']);
    ...
    {
        return MaintenanceSchedule::with(['asset.category', 'asset.room.building', 'logs'])
            ->find($id);
    }
