...
{
    public function __construct(protected MaintenanceLogService $logService) {}
    ...
    public function index(Request $request): View
    {
        ...
        return view(
            "management.maintenance-logs.index",
            compact(
                "logs",
                "search",
                "assetId",
    ...
    public function create(): View
    {
        ...
        return view(
            "management.maintenance-logs.create",
            compact("assets", "schedules"),
        );
    }
    ...
    public function store(StoreMaintenanceLogRequest $request): RedirectResponse
    {
        try {
            ...
            return back()
                ...
                ->with(
                    "error",
                    "Gagal menambahkan log pemeliharaan: " . $e->getMessage(),
                );
        }
    }
    ...
    public function show(MaintenanceLog $maintenanceLog): View
    {
        ...
        return view(
            "management.maintenance-logs.show",
    ...
    public function edit(MaintenanceLog $maintenanceLog): View
    {
        ...
        return view(
            "management.maintenance-logs.edit",
            compact("maintenanceLog", "assets", "schedules"),
        );
    }
    ...
    public function update(
        ...
        try {
            ...
            return back()
                ...
                ->with(
                    "error",
                    "Gagal memperbarui log pemeliharaan: " . $e->getMessage(),
                );
        }
    }
    ...
    public function destroy(MaintenanceLog $maintenanceLog): RedirectResponse
    {
        try {
            ...
            return back()->with(
                "error",
                "Gagal menghapus log pemeliharaan: " . $e->getMessage(),
            );
        }
    }

    /**
     * Print the specified maintenance log.
     */
    public function print(MaintenanceLog $maintenanceLog): View
    {
        $maintenanceLog->load([
            "asset.category",
            "asset.room.building",
        ...
        return view(
            "management.maintenance-logs.print",
            compact("maintenanceLog"),
        );
    }
}
